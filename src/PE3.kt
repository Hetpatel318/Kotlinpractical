...
class Student(
    ...
    constructor(
        firstName: String,
        lastName: String,
        enrollmentNo: String     ) : this(firstName, lastName, 0, enrollmentNo, "CSE", "A", "Batch-1") {
    ...
    constructor(
        ...
        lastName: String,
        age: Int,
        enrollmentNo: String     ) : this(firstName, lastName, age, enrollmentNo, "CSE", "A", "Batch-1") {
...
fun main() {
    ...
    val student1 = Student("Het", "Patel", 20, "2023001", "CSE", "A", "Batch-1")
    studentList.add(student1)
    println()

    val student2 = Student("Darshan", "Singh", 19, "2023002", "CSE", "B", "Batch-2")
